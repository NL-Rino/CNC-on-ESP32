...
| Trạm sạc | **hộc chữ U**: ngoài 40 × 40 cm, lòng trong 31 × 31 cm, vách dày 4.5 cm. LED IR 56 kHz gắn **giữa thành trong**, chiếu thẳng ra cửa | Ba mặt vách phải phẳng và **không bóng loáng** — LiDAR cần dội về đều thì mới đo được độ lõm và khớp được trục. **Vát hai góc trong ở miệng**: 8 cm đầu nong ra ~37 cm rồi thu về 31 cm. Không có đoạn vát này thì cửa sổ bắt chỉ còn ±2 mm thay vì ±38 mm (đo trong mô phỏng) — xem `docs/DESIGN.md` mục 10(f) |
